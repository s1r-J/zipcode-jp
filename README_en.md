...
For ddresses of individual number, `lookupJigyosyo` function can be used.

Both of all over data and individual number are provided from `lookupAll` function.

If a parameter is less than 7 characters, it will perform a prefix search.

### Data

Data source is [all over data from Japan Post](https://www.post.japanpost.jp/zipcode/dl/readme.html).

Since verison 0.2, this module use [individual number](https://www.post.japanpost.jp/zipcode/dl/jigyosyo/index-zip.html).
